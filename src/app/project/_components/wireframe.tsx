            ...
            <div className="py-5">
                ...
                {selectedMenu === 'find' && (
                    ...
                    <div className="flex flex-col">
                        <div className="mb-3 flex">
                            <img
                                src="/wireframe/find_buddy.png"
                                alt={`wireframe-${selectedMenu}`}
                                className="w-[685px]"
                            />
                            <span className="ml-4 p-2 text-gray-700 text-[15px] leading-relaxed max-w-sm">
                                ⦿ 왼쪽 박스는 긴급하게 버디 또는 러브를 찾고자 할 때 노출되는 공간입니다. <br />⦿ 기본
                                정보는 간단하게 요약되며, ‘대화하기’ 버튼을 누르면 버디토키로 연결되어 실시간 대화가
                                가능합니다.
                            </span>
                        </div>
                        <div className="mb-3 flex">
                            ...
                            />
                            <span className="ml-4 p-2 text-gray-700 text-[15px] leading-relaxed max-w-sm">
                                ⦿ 캘린더 기본은 이번주만, 펼쳐보기 = 한달. 그 이후의 시간은 버디룸에서 예약 가능. <br />
                                ⦿ 왼쪽 박스는 긴급하게 버디 또는 러브를 찾고자 할 때 노출되는 공간입니다. <br />⦿ 기본
                                버튼은 대화하기 - 대화하기 눌렀을 때에는 상세한 정보없이 대화 <br />⦿ 예약하기 활성화는
                                날짜, 시간 설정 후에 예약정보가 보내짐.
                            </span>
                        </div>
                        {/* love */}
                        <div className="mb-3 flex">
                            <img
                                src="/wireframe/find_love.png"
                                alt={`wireframe-${selectedMenu}`}
                                className="w-[685px]"
                            />
                            <span className="ml-4 p-2 text-gray-700 text-[15px] leading-relaxed max-w-sm">
                                ⦿ 러브(펫시터를 구하는 사용자)를 위한 페이지 입니다. <br />⦿ 기본 정보는 간단하게
                                요약되며, ‘대화하기’ 버튼을 누르면 버디토키로 연결되어 실시간 대화가 가능합니다.
                            </span>
                        </div>
                        <div className="mb-3">
                            <img src="/wireframe/love_find_toki.png" alt={`wireframe-${selectedMenu}`} />
                        </div>
                        <div className="mb-3">
