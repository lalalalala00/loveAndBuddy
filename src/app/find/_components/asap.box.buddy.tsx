...
const AsapBoxBuddy = () => {
  ...
  return (
    <div
      className="relative flex w-full bg-white rounded-xl shadow p-2 flex-col custom-card-bg-white mb-3"
      style={{
        backgroundImage: "url(/project/buddy_sit_1.png)",
        backgroundSize: "cover",
        // backgroundPosition: "center",
      }}
    >
      {/* <div
        className="absolute top-0 left-0 w-full h-[165px] rounded-t-xl"
        style={{
          backgroundImage: "url(/project/buddy_sit_1.png)",
          backgroundSize: "cover",
          backgroundPosition: "center",
      ...
      ></div> */}
      <div className="absolute top-0 left-0 w-full h-full z-1 bg-white/40 rounded-xl"></div>
      ...
      <NameTag imgCss="hidden" tagCss="z-2" find />
      <div className="text-[11px] text-gray-500 ml-2 text-center z-2">📸 · 🪪 · ✔️</div>
      <div className="flex flex-col text-[12px] items-start w-full px-1 my-2 z-2">
      ...
      <button className=" custom-card-hover w-full mt-1 text-[12px] py-1 rounded-md py-2 bg-white/60 border-b border-gray-300 z-2">
        대화하기
      </button>
    </div>
  );
