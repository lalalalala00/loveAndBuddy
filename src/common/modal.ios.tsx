    ...
    isOpen && (
      <div className="fixed inset-0 z-[99] bg-black/40 backdrop-blur-[2px] flex justify-center items-center">
        ...
        >
          ...
          <div className="text-center text-[14px] text-gray-700">{children}</div>

          <div className="flex border-t border-gray-200">
            <button
              onClick={leftAction}
              className="w-1/2 py-4 text-[15px] font-semibold text-[#5b7551] border-r border-gray-200 hover:bg-gray-100 hover:rounded-bl-3xl"
            >
              {leftComment}
            </button>
            <button
              onClick={handleModalState}
              className="w-1/2 py-4 text-[15px] font-medium hover:bg-gray-100 hover:rounded-br-3xl"
            >
              Close ♥ ັ
            </button>
          </div>
